#HSO: 
head<- "complete_PF03055_1.cT_1.out"
#TREE: 
tree<- "OG5_128633_aurlibcd_1.HMMAL.cT.derep.V4.hmmal.cT.newick"
#OUT: 
out<- "OG5_128633_aurlibcd_1.HMMAL.cT.derep.V4.hmmal.cT.derep.txt"
